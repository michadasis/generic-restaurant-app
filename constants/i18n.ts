...
export const i18n = {
  gr: {
    ...
    aboutDesc1: 'Η εφαρμογή αναπτύχθηκε για τους φοιτητές του Πανεπιστημίου Δυτικής Μακεδονίας, ώστε να έχουν εύκολη πρόσβαση στο εβδομαδιαίο μενού.',
    aboutDesc2: 'Αναπτύχθηκε με React Native και σχεδιάστηκε για κινητές συσκευές.',
